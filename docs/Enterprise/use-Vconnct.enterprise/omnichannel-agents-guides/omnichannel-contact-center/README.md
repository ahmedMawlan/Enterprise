...
To access the Contact Center, click thei  icon on the Omnichannel navigation tab, and a screen displaying all the records is seen.
...
{% hint style="success" %}
As a Vconnct.Enterprise enterprise user; you can [assign an Omnichannel contact to a particular manager](omnichannel-contact-manager-assignment.md).&#x20;
{% endhint %}

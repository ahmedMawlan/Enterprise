...
* Select the **start** and **end date** to limit the search results to a specific time frame. The ![]**(img)** **three-dots icon** also provides other time options like **Today**, **Last Week,** etc.

...
{% hint style="warning" %}
Vconnct.Enterprise notifies you if the user is already an existing channel member**.**
{% endhint %}
...
{% hint style="info" %}
This link will ask the invitee to sign up if they are outside your Vconnct.Enterprise workspace before granting them access to the channel.
{% endhint %}

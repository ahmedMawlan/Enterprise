...
This page explains the ins and outs of messaging in Vconnct.Enterprise.
...
To compose a message in Vconnct.Enterprise, go to the channel or user you want to send a message to. Type the message in the message box and press Enter or the **Send** Button.
...
* By dragging and dropping the file on Vconnct.Enterprise
...
When using Vconnct.Enterprise through a web browser, give Vconnct.Enterprise permission to use your microphone.
...
When using Vconnct.Enterprise through a web browser, give Vconnct.Enterprise permission to use your webcam.
...
### From Google Drive to Vconnct.Enterprise
...
### From Vconnct.Enterprise to Google Drive
...
Vconnct.Enterprise changes common emoticons, or symbols used to represent emoji, to the equivalent emoji. For example, `:)` converts to the `:smiley:` emoji.

### Disabling emojis

Emojis can be enabled/disabled in [Your Account](../user-panel/my-account/) settings under the **Messages** section.
...
* Image: `![Alt text](https://Vconnct.Enterprise/favicon.ico)`
* Link: `[Lorem ipsum dolor](https://www.Vconnct.Enterprise/)` or `<https://www.Vconnct.Enterprise/ |Lorem ipsum dolor>`

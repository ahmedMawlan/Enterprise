...
![Selecting OTR-Panel] **img**

**User A:** Start OTR.

![Starting OTR-Chat] **img**

_User B:_ Accept the OTR invitation.

![Accepting the invitation] **img**
...
![OTR messages visual display] **img**
...
![Options during OTR conversation] **img**

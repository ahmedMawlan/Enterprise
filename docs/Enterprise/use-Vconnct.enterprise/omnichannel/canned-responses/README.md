...
Canned responses allow you to save message snippets that you can call with shortcuts (preceded with `!`) to communicate quickly. They can be configured to work both in Omnichannel conversations or general messaging within your Vconnct.Enterprise workspace.

## Canned Responses Vconnct.Enterprise Admin's Guide

As a Vconnct.Enterprise workspace admin, you can enable and disable Canned Responses on your server.

### Enable Vconnct.Enterprise Canned Responses

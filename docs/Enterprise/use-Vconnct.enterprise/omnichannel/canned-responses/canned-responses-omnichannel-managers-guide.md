...
{% hint style="info" %}
Canned responses allow you to save message snippets that you can call with shortcuts (preceded with `!`) to communicate a quick note to your visitors in Omnichannel and for messaging in regular conversations inside your Vconnct.Enterprise's workspace.
{% endhint %}

If you are using canned responses for the first time, please check the [Vconnct.Enterprise Admin's guide for canned responses](./#canned-responses-Vconnct.Enterprise-admins-guide) or contact your workspace Administrator to enable canned responses on your workspace.

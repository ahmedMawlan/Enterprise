...
VoIP is the technology behind Vconnct.Enterprise voice-as-channel feature.
...
Through VoIP technologies, Vconnct.Enterprise is able to incorporate telephony-based communication protocols into its applications, promoting the transition between analog and digital technologies.
...
Once Vconnct.Enterprise voice-as-channel or VoIP is in place; our Enterprise Edition provides many call center features.

## Vconnct.Enterprise VoIP architecture
...
* To achieve this, there is an association made between the Vconnct.Enterprise agent and the SIP identity.
...
Admins and managers use Vconnct.Enterprise's UI to configure and monitor the customer-managed PBX. To receive real-time PBX events, Vconnct.Enterprise’s backend has to connect to the PBX manager interface. The customer is responsible for creating the configuration on PBX so that the management APIs/interface is accessible from Vconnct.Enterprise’s backend.

![Connector Architecture] **img**
